    ...
    return (
        <div style={{ ...mainDivStyle }}>
            ...
            <Typography variant="body1" paragraph style={ typographyStyles.colorfulEmphasis }>
                People in real life usually call me by my first name (unexpected, I know) Carlos. Online I usually go by "Nihu" or "zebrajr", depending on <s>what age I had when I created the account</s> which kind of service I registered on.
            </Typography>
            <Typography variant="body1" paragraph style={ typographyStyles.colorfulEmphasis }>
                I enjoy technologies in general, but I'm mainly interested in "all" about System Administration (SysAdmin), Development and Operations (DevOps), and solving problems and / or faciliating life via Coding.
            </Typography>
            <Typography variant="body1" paragraph style={ typographyStyles.colorfulEmphasis }>
